...
import com.everbravo.CalculadoraSpringApiApplication;
...
@SpringBootTest(classes = CalculadoraSpringApiApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
public class CalculadoraSpringApiApplicationTests {
    @LocalServerPort
